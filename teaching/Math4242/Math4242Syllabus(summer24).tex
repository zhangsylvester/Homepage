...
\begin{center}
{\color{red}\bf This is a preliminary version of the syllabus. All information are subject to changes.}	
\end{center}
...
\noindent\textbf{Course Webpage:} \url{TBD} 
\vskip.15in
\noindent\textbf{Office Hours:} TBD
\vskip.15in
\noindent\textbf{Credit:}   This is a 4-credit upper-division Math course.
\vskip.15in
\noindent\textbf{Workload:}   7.5 hrs instruction + 15 hrs individual study (per week on average).
...
\end{itemize}
Other supplementary materials are:
\begin{itemize}
\item To be added.
\end{itemize}
...
~Week 1: Introduction and basic abstract algebra (TBD)\\
~Week 2: Linear Algebraic Systems (Olver \S1.1-1.6, 1.8-1.9) [Exam 1]	\\
~Week 3: Vector Spaces and Linearity (Olver \S2.1-2.5)  \\
~Week 4: Inner Products and Norms (Olver \S3.1-3.5)  [Exam 2]\\
~Week 5: Orthogonality (Olver \S4.1-4.4)  \\
~Week 6:  (TBD)  [Exam 3]\\
~Week 7: Eigenvalues and Singular Values (Olver \S8.1-8.3, 8.5-8.7)  \\
~Week 8: Special Topics (TBD) [Exam 4]
\end{flushleft}
\end{minipage}
\end{center}
...
%\begin{flushleft}
%Midterm \#1      \dotfill ~June 16, 2023 \\
%NO CLASS         \dotfill ~June 19, 2023 \\
%NO CLASS         \dotfill ~July 4, 2023  \\
%Midterm \#2      \dotfill ~July 14, 2023  \\
%Final Exam Day    \dotfill ~July 28, 2023  \\
%\end{flushleft}
%\end{minipage}
%\end{center}
...
\begin{itemize}[noitemsep]
	\item Homework will be assigned every week (except for the last week) and due on Saturday 11:59 pm.
	\item There are 7 assignments in total, and 2 lowest scores will be dropped. After dropping, each homework will contribute 8\% to the final grade.
	\item The two drops will accommodate absences such as sickness, therefore late homework assignments are NOT accepted, regardless of the situation.
	\item Students are allowed, and in fact encouraged, to collaborate on homework problems. But each students must write up homework assignments on their own, demonstrating individual understanding. Students must acknowledge their collaborators in their individual submission.
...
\noindent\textbf{Exams:}  
\begin{itemize}[noitemsep]
	\item There are 4 exams in total. Each worths the same amount of credit.
	\item Exams take place on Thursdays.
	...
	\item The lowest exam score will be dropped. Each exam contributes to 20\% of final grade.
