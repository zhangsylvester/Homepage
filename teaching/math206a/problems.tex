...
\begin{problem}[Bonus, 2]
	Can you describe the action of divided difference operator $\partial_i$ on ${\bf Y}_{k \times (n-k)}\cong GP_{k,n}\subset S_n$. Here ${\bf Y}_{k \times (n-k)}$ is the set of all partitions that fit inside a $k\times (n-k)$ rectangle.
\end{problem}
